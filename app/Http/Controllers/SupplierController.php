...
class SupplierController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $supplier = SupplierModel::select('supplier_id', 'supplier_kode', 'supplier_nama', 'supplier_alamat', 'supplier_notlp');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'supplier_notlp' => 'required|string|max:15' // nomor telepon harus diisi dan maksimal 15 karakter
        ]);
        SupplierModel::create([
            'supplier_kode'  => $request->supplier_kode,
            'supplier_nama'  => $request->supplier_nama,
            'supplier_alamat' => $request->supplier_alamat,
            'supplier_notlp' => $request->supplier_notlp
        ]);
    ...
    public function export_excel()
    {
        ...
        $supplier = SupplierModel::select('supplier_kode', 'supplier_nama', 'supplier_alamat', 'supplier_notlp')
        ...
        $sheet->setCellValue('E1', 'No Telepon'); // Ubah ini ke kolom E
        ...
        foreach ($supplier as $key => $value) {
            ...
            $sheet->setCellValue('E' . $baris, $value->supplier_notlp); // Ubah ini ke kolom E
            $baris++;
            $no++;
        }
